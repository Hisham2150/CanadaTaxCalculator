...
public class YukonCalculationPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yukon_calculation_page);

        flag = (ImageView)findViewById(R.id.yukonflag);
        Bundle bundle = getIntent().getExtras();

        if(bundle!=null){

            int YukonId = bundle.getInt("YukonId");
            flag.setImageResource(YukonId);
        }
            ...
            public void onClick(View view) {
                ...
                if(!incometaxInString.isEmpty())
                    try{
                        ...
                        provtax.setText(ProvincialTaxCalculations.yukonProvincialtax(incometaxInString));
                        fedtax.setText(FederalTaxCalculations.Federaltaxcalc(incometaxInString));
                        double incomeAfterTaxDouble = Double.parseDouble(incometaxInString) -(Double.parseDouble(CPP_QPP_EI.CPP_EICalc(incometaxInString)) + Double.parseDouble(ProvincialTaxCalculations.yukonProvincialtax(incometaxInString)) + Double.parseDouble(FederalTaxCalculations.Federaltaxcalc(incometaxInString)));
