...
public class NunavutCalculationPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nunavut_calculation_page);

        flag = (ImageView)findViewById(R.id.nunavutflag);
        Bundle bundle = getIntent().getExtras();

        if(bundle!=null){

            int NunavutId = bundle.getInt("NunId");
            flag.setImageResource(NunavutId);
        }
            ...
            public void onClick(View view) {
                ...
                if(!incometaxInString.isEmpty())
                    try{
                        ...
                        provtax.setText(ProvincialTaxCalculations.nunavutProvincialtax(incometaxInString));
                        fedtax.setText(FederalTaxCalculations.Federaltaxcalc(incometaxInString));
                        double incomeAfterTaxDouble = Double.parseDouble(incometaxInString) -(Double.parseDouble(CPP_QPP_EI.CPP_EICalc(incometaxInString)) + Double.parseDouble(ProvincialTaxCalculations.nunavutProvincialtax(incometaxInString)) + Double.parseDouble(FederalTaxCalculations.Federaltaxcalc(incometaxInString)));
