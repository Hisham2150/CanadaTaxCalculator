...
public class NewfoundlandCalculationPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newfoundland_calculation_page);

        flag = (ImageView)findViewById(R.id.newfoundlandflag);
        Bundle bundle = getIntent().getExtras();

        if(bundle!=null){

            int NFLId = bundle.getInt("NFLId");
            flag.setImageResource(NFLId);
        }
            ...
            public void onClick(View view) {
                ...
                if(!incometaxInString.isEmpty())
                    try{
                        ...
                        provtax.setText(ProvincialTaxCalculations.newFoundlandProvincialtax(incometaxInString));
