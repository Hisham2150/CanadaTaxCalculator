...
public class AlbertaCalculationPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alberta_calculation_page);

        flag = findViewById(R.id.albertaflag);
        Bundle bundle = getIntent().getExtras();

        if(bundle!= null){

            int albertaId = bundle.getInt("AlbertaId");
            flag.setImageResource(albertaId);
        }
            ...
            public void onClick(View view) {
                ...
                if(!incometaxInString.isEmpty())
                    try{
                        ...
                        provtax.setText(ProvincialTaxCalculations.albertaProvincialtax(incometaxInString));
                        fedtax.setText(FederalTaxCalculations.Federaltaxcalc(incometaxInString));
                        double incomeAfterTaxDouble = Double.parseDouble(incometaxInString) -(Double.parseDouble(CPP_QPP_EI.CPP_EICalc(incometaxInString)) + Double.parseDouble(ProvincialTaxCalculations.albertaProvincialtax(incometaxInString)) + Double.parseDouble(FederalTaxCalculations.Federaltaxcalc(incometaxInString)));
