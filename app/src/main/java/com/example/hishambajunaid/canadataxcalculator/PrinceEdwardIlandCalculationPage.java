...
public class PrinceEdwardIlandCalculationPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prince_edward_iland_calculation_page);

        flag = (ImageView)findViewById(R.id.princeedwardflag);
        Bundle bundle = getIntent().getExtras();

        if(bundle!=null){

            int PrinceEwardId = bundle.getInt("PrinceEId");
            flag.setImageResource(PrinceEwardId);
        }
            ...
            public void onClick(View view) {
                ...
                if(!incometaxInString.isEmpty())
                    try{
                        ...
                        provtax.setText(ProvincialTaxCalculations.PrinceEdwardProvincialtax(incometaxInString));
                        fedtax.setText(FederalTaxCalculations.Federaltaxcalc(incometaxInString));
                        double incomeAfterTaxDouble = Double.parseDouble(incometaxInString) -(Double.parseDouble(CPP_QPP_EI.CPP_EICalc(incometaxInString)) + Double.parseDouble(ProvincialTaxCalculations.PrinceEdwardProvincialtax(incometaxInString)) + Double.parseDouble(FederalTaxCalculations.Federaltaxcalc(incometaxInString)));
